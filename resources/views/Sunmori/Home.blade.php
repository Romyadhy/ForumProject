	...
	<main id="hero" class="relative -top-20"> <!-- Main Content -->
		<div class="bg-white-950 "> <!-- Hero Section-->
			<div class="mx-auto flex h-screen items-center w-9/12 "> 
				...
				<div class="basis-1/2">
					<img src="{{ asset('img/ucok.jpg') }}" alt="Deskripsi Gambar">
				</div>
        ...
        <div id="Home" class="bg- pt-20 pb-20"> <!-- services -->
            <div class="w-9/12 mx-auto">
                <div class="flex flex-col place-items-center"> <!-- judul -->
                    <div>
                        <div class="flex items-center">
                        ...
                        <h3 class="text-3xl">Kegiatan</h3>
                    </div>
                </div>

                <div class="grid grid-cols-3 gap-10 py-10"> <!-- cards -->
                    <div class="rounded-lg bg-red-500 shadow-lg">
                        <div class="flex flex-col items-center py-10 px-10">
                            <div class="h-10 w-10  rounded-2xl">
                                <img class="rounded-md w-72" src="img/ML.png" alt="">
                            </div>
                            <h4 class="text-black mt-6 text-center">
                                Sunmori
                            </h4>
                            <div class="basis-1/2 flex flex-col items-center">
                                <div class="w-48 mb-5" >
                                    <img class="mx-auto" src="img/sunmor (3).jpeg" alt="WISWA" style="max-width: 95%; max-height: 95%; border-radius: 50%;">
                                </div>
                                <div class="w-48">
                                    <img class="mx-auto" src="img/sunmor (4).jpeg" alt="WISWA" style="max-width: 95%; max-height: 95%; border-radius: 50%;">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="rounded-lg bg-red-500 shadow-lg">
                        <div class="flex flex-col items-center py-10 px-10">
                            <div class="h-10 w-10 rounded-2xl">
                                <img class="rounded-md w-72" src="img/tlk.png" alt="">
                            </div>
                            <h4 class="text-black mt-5">
                                Futsal
                            </h4>
                            <div class="basis-1/2">
                                <img class="mx-auto" src="img/futsal.jpeg" alt="WISWA" style="max-width: 95%; max-height: 95%; border-radius: 50%;">
                            </div>
                        </div>
                    </div>
                    <div class="rounded-lg bg-red-500 shadow-lg">
                        <div class="flex flex-col items-center py-10 px-10">
                            ...
                            <div class="basis-1/2">
                                <img class="mx-auto" src="img/anniv.jpeg" alt="WISWA" style="max-width: 95%; max-height: 95%; border-radius: 50%;">
                            </div>
                        </div>
                </div>
            </div>
